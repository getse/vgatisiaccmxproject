...
CVE_SCIAN_REQUERIMIENTOS_COMPRA INT,
CALIFICACION INT,
...
ALTER TABLE INFRA.ASISTENTES ADD CONSTRAINT ASIST_SERVD_FK FOREIGN KEY (ID_DIPLOMADO) REFERENCES INFRA.SERVICIOS_DIPLOMADO (ID_DIPLOMADO);
...
ID_USUARIO_PYME INT NOT NULL ,
ID_USURIO_CONSULTOR INT NOT NULL);
...
ALTER TABLE INFRA.REL_CONSULTORAS_PYME ADD CONSTRAINT RCP_CONSULT_FK FOREIGN KEY (ID_USURIO_CONSULTOR) REFERENCES INFRA.CONSULTORAS (ID_USUARIO);
ALTER TABLE INFRA.REL_CONSULTORAS_PYME ADD CONSTRAINT INFRA.REL_CONS_PYME_UNIQUE UNIQUE(ID_USUARIO_PYME, ID_USURIO_CONSULTOR);
