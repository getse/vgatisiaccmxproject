...
<fieldset id="requerimientos">
	<div id="busqPyME" ${pymesList==null && idUsuario==0 ? ' style="display: block;" ' :' style="display: none;"' }>
		<s:form 
			action="consultorPyMEsBusquedaShow" 
			namespace="/consultor" 
			theme="simple" 
						...
						<s:iterator value="listPyMEs" status="stat">				
								...
								<tr>
									...
									<td class="${((stat.index % 2) == 0) ? 'cuerpo1TablaResumen' : 'cuerpo2TablaResumen'}"
													...
													/consultor/consultorPyMEsBusquedaShow.do?idUsuario=${idUsuario}" onclick="javascript: $(idProcesa)[0].style.display = 'block';">Expediente</a></td>
								</tr>		
						</s:iterator>
					</tbody>
					<tr>
