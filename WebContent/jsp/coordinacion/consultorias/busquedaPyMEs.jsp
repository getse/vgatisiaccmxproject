...
<fieldset id="requerimientos" >
	<s:if test="idUsuario == 0">
		...
		<br />
		<s:form action="coordinadorConsultoriasBusquedaPyMEs" namespace="/consultorias/coordinacion" theme="simple" onsubmit="return validacionBusqueda()">
				...
				<tr>
					<td>
						<table width="100%">
							...
							<tr>
								<td>
									<select id="catProd1" name="cat1" style="width: 500px;" onchange="javascript: showCombo(this.value, 2, 'coordinadorConsultoriasBusquedaPyMEs.do');" onfocus="javascript: ayudasHelp('11');" onblur="javascript:ayudasHelpBlo('11');">
									...
									<select id="catProd2" name="cat2" style="width: 500px; display: none;" onchange="javascript: showCombo(this.value, 3, 'coordinadorConsultoriasBusquedaPyMEs.do');" onfocus="javascript: ayudasHelp('11');" onblur="javascript:ayudasHelpBlo('11');">
										<option selected="selected" value="-1">--Seleccione una opción--</option>
										<s:iterator value="listCat2" status="stat" >
											<option value="${cveScian}">${descScian}</option>
										</s:iterator>
									</select>
									<select id="catProd3" name="cat3" style="width: 500px; display: none;" onchange="javascript: showCombo(this.value, 4, 'coordinadorConsultoriasBusquedaPyMEs.do');" onfocus="javascript: ayudasHelp('11');" onblur="javascript:ayudasHelpBlo('11');">
										<option selected="selected" value="-1">--Seleccione una opción--</option>
										<s:iterator value="listCat3" status="stat" >
											<option value="${cveScian}">${descScian}</option>
										</s:iterator>
									</select>
									<select id="catProd4" name="cat4" style="width: 500px; display: none;" onchange="javascript: showCombo(this.value, 5, 'coordinadorConsultoriasBusquedaPyMEs.do');" onfocus="javascript: ayudasHelp('11');" onblur="javascript:ayudasHelpBlo('11');">
										<option selected="selected" value="-1">--Seleccione una opción--</option>
										<s:iterator value="listCat4" status="stat" >
											<option value="${cveScian}">${descScian}</option>
										</s:iterator>
									</select>
									<select id="catProd5" name="cat5" style="width: 500px; display: none;" onchange="javascript: showCombo(this.value, 6, 'coordinadorConsultoriasBusquedaPyMEs.do');" onfocus="javascript: ayudasHelp('11');" onblur="javascript:ayudasHelpBlo('11');">
										<option selected="selected" value="-1">--Seleccione una opción--</option>
								...
								<td>
									<select id="estado" name="estado" style="width: 200px;" onfocus="javascript: ayudasHelp('12');" onblur="javascript:ayudasHelpBlo('12');">
					...
					<s:iterator value="listPyMEs" status="stat">
						...
						<tr>
							...
							<td class="${((stat.index % 2) == 0) ? 'cuerpo1TablaResumen' : 'cuerpo2TablaResumen'}" align="center">
								<a href="${pageContext.request.contextPath}/consultorias/coordinacion/coordinadorConsultoriasBusquedaPyMEs.do?idUsuario=${idUsuario}" onclick="javascript: $(idProcesa)[0].style.display = 'block';">Expediente</a>
							</td>
						</tr>
					</s:iterator>
				</tbody>
	...
	<!-- EXPEDIENTE PYME -->
			...
			<tr>
				<td colspan="2">
					...
					<s:if test="estadosVentas.morelos != null">
						<div class="flotantes2">
							<div class="cuerpo1TextoResumen">
								<ul><li>${estadosVentas.morelos}</li></ul>
							</div>
						</div>
					</s:if>
		...
		<table class="submit_tabla">
			<tr>
				...
				<td><input class="botonenviar" value="Regresar" type="button" onclick="javascript: window.history.back();" /></td>
				<td style="width: 450px;"></td>
			</tr>
		</table>
	</s:else>
