								...
								<tr>
									...
									<td>
										...
										<s:textfield
											...
											onkeypress="javascript: if(event.which == 13 || event.keyCode == 13) busqueda(true);"
											value="%{requerimientos.busqueda}" /> <a href="javascript: busqueda(true);">
	...
	<div class="overlay-container">
		<div class="window-container zoomin">
			...
			<div style="text-align: center; margin-top: -47.5px;">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input class="close" style="color: #646464;" value="Elegir este resultado" type="button" onclick="javascript: setTimeout(elegir(true), 5000);" />
			</div>
		</div>
