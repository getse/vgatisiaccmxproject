...
<table style="width: 1215px; margin-top: -15px;">
	<tr>
		...
		<s:if test="%{#session.Usuario.rol=='Tractora'}">
			<td style="width: 85%;"><label class="headerlabelusuario">${session.super ? '<font color="orange"><b>SuperUsuario - </b></font>' : ''}Administrador Tractora:&nbsp;${session.Usuario.id}&nbsp;</label></td>
