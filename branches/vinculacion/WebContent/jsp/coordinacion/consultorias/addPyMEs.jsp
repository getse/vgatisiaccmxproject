...
<fieldset id="requerimientos" >
	...
	<s:form action="coordinadorConsultoriasPyMEsShow" namespace="/consultorias/coordinacion" theme="simple" onsubmit="return validacionAgregar()">
		...
		<!-- CONTACTO TIPO VENTAS -->
			...
			<tr>
				<td>&nbsp;</td>
				<td><s:label cssClass="etiquetaAyuda" id="ayudasDisplay6" style="display:none;margin-top:0px;" value="Seleccione la empresa Tractora que se asignará a la PyME." /></td>
			</tr>
			<tr>
