				...
				<td>
					<table width="100%">
						<tr>
							...
							<td style="width: 40%;">
								<s:label cssClass="etiquetaCaptura" value="Grandes Empresas:" />
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<div id="ayudasDisplay12" style="display: none; margin-bottom: 0px; margin-top: -5px;">
									<s:label cssClass="etiquetaAyuda" value="Seleccione una de las Grandes Empresas." />
									<br />
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<select id="tractora" name="tractora" style="width: 200px;" onfocus="javascript: ayudasHelp('12');" onblur="javascript:ayudasHelpBlo('12');">
									<option value="-1">--Seleccione una de las Grandes Empresas--</option>
