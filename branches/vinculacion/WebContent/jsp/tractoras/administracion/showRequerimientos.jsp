...
<div
	id="scian"
	style="display: none;"><s:select
	list="listCatProductos"
	listValue="descScian"
	listKey="cveScian"
	cssStyle="width: 0px;"
	id="idCatScianCcmx"></s:select></div>
		...
		<tr>
			...
			<table>
				...
				<tr>
					...
					<div
						id="idDivPro"
						style="display: none; margin-bottom: 0px; margin-top: -15px;"><s:label
						cssClass="etiquetaAyuda"
						value="Defina el producto solicitado en tres palabras." /></div>
					<div
						id="idDivPro2"
						style="display: block; margin-bottom: 0px; margin-top: -15px;"><s:label
						cssClass="etiquetaAyuda"
						value="" /></div>
					</td>
				</tr>
				...
				<tr>
					...
					<div
						id="idDivTipPro"
						style="display: none; margin-bottom: 0px; margin-top: -10px;"><s:label
						cssClass="etiquetaAyuda"
					...
					<div
						id="idDivTipPro2"
						style="display: block; margin-bottom: 0px; margin-top: -5px;"><s:label
						cssClass="etiquetaAyuda"
						value="" /><br />
					<s:label
						cssClass="etiquetaAyuda"
			...
			<table>
				<tr>
					...
					<div
						id="idDivFil"
						style="display: none; margin-bottom: 0px; margin-top: -5px;"><s:label
						cssClass="etiquetaAyuda"
					...
					<div
						id="idDivFecSum"
						style="display: none; margin-bottom: 0px; margin-top: 0px;"><s:label
						cssClass="etiquetaAyuda"
		...
		<tr>
			...
			<table>
				<tr>
					...
					<div
						...
						class="quitar"
						onblur="javascript:blurAyuda('idDivLug');"
						onclick="javascript:focoAyuda('idDivLug');javascript:document.getElementById('idInput').value=''; document.getElementById('lugarSum').style.display='none'">-limpiar</label></div>
					<div
						id="idDivLug"
						style="display: none; margin-bottom: 0px; margin-top: 0px;"><s:label
						cssClass="etiquetaAyuda"
					...
					<div
						id="idDivLug2"
						style="display: block; margin-bottom: 0px; margin-top: 0px;"><s:label
						cssClass="etiquetaAyuda"
			...
			<table>
				<tr>
					...
					<div
						id="idDivConPag"
						style="display: none; margin-bottom: 5px; margin-top: 0px;"><s:label
						cssClass="etiquetaAyuda"
						value="Seleccione una opción." /></div>
					<div
						id="idDivConPag2"
						style="display: block; margin-bottom: 5px; margin-top: 15px;"><s:label
						cssClass="etiquetaAyuda"
...
<div
	...
	${requerimientos.producto==null?
	' style="display: none;"
	':' style="display: block;"' }><s:if test="mensaje!=null">
	<br />
	<table class="nota">
		<tr>
