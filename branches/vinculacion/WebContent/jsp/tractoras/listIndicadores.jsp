					...
					<s:iterator value="listPyMEsIndicadores" status="stat">
						<tr>
							...
							<td class="${((stat.index % 2) == 0) ? 'cuerpo1TablaResumen' : 'cuerpo2TablaResumen'}" align="center">
								<a href="${pageContext.request.contextPath}/comprador/compradorIndicadoresShow.do?indicador=${idTractora}&rel=${idUsuario}&empresa=${nombreComercial}" onclick="javascript: $(idProcesa)[0].style.display = 'block';">Subir</a>
							</td>
							<td class="${((stat.index % 2) == 0) ? 'cuerpo1TablaResumen' : 'cuerpo2TablaResumen'}" align="center">
								<a href="${pageContext.request.contextPath}/comprador/compradorIndicadoresShow.do?calificaPyME=${idTractora}&rel=${idUsuario}" onclick="javascript: $(idProcesa)[0].style.display = 'block';">Calificar</a>
							</td>
						</tr>
					</s:iterator>
				</tbody>
		...
		<s:hidden name="rel" id="idPyME" value="%{rel}" />
			...
			<div id="contFormula9" style="display: none; ">
				<table>
					...
					<tr>
						<td>
							<s:textfield size="40" id="vt29" maxlength="100" onkeypress="return validaNumero(event)"
									onblur="javascript: calculaIndicador9();"></s:textfield>
						</td>
						<td>
