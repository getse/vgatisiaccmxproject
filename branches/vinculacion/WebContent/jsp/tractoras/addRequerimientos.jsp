...
<iframe
	...
	function buscar() {
		document.getElementById("idReqTipPro").value = document
				.getElementById('idCampoTipoProducto').value;
		document.getElementById("idReqIdReq").value = document
				.getElementById('idReq').value;
