...
<s:textfield size="25" id="idCampoRequerimiento" name="requerimientos.requerimiento"></s:textfield><br />
...
<s:text id="idCamReqTipPro" name="requerimientos.tipoProducto" />
...
<img src="<%=request.getContextPath()%>/img/calendario.png" width="16" height="16" title="Seleccione una fecha" id="lanzador" style="cursor:hand" ></img>
<br />
...
<img src="<%=request.getContextPath()%>/img/calendario.png" width="16" height="16"  title="Seleccione una fecha" id="lanzador2" style="cursor:hand" ></img>
<br />
...
<s:form name="frmBuscar" action="addReq" namespace="/tractora/requerimientos" theme="simple" method="get">
	<s:hidden name="requerimietos.idRequerimiento"  value="%{requerimietos.idRequerimiento}"/>
	<s:hidden name="requerimietos.requerimiento"  value="%{requerimietos.requerimiento}"/>
...
--<s:property value="%{listRequerimientos}"/>--<br></br>
--<s:property value="%{requerimientos}"/>--<br></br>
--<s:property value="listProductos"/>--<br></br>
...
<div class="overlay-container">
	<div class="window-container zoomin">
		...
		<br/>
		<span class="close">Cancelar</span><span class="close" onclick="regresa();">Aceptar</span>
		...
		<script language="JavaScript">
			...
			function regresa() {
				alert('-' + document.getElementById('idCampoRequerimiento').value);
				document.frmRegresar.submit();
			}
			function buscar() {
				document.getElementById("idReqTipPro").value=document.getElementById('idCampoRequerimiento').value;
...
<s:if test='%{busqueda=="true"}'>
	<input type="button" id="idBtnBuscar" value="" class="button" data-type="zoomin" />
	<script>
		setTimeout ("breakOut()", 90);
		function breakOut() {
