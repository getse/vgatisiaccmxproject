...
<body>
	<fieldset id="requerimientos">
		...
		<s:form
			...
			action="compradorRequerimientoSave"
			namespace="/comprador"
	...
	':' style="display: block;"' }>
			...
			<table>
				...
				<s:if test="requerimientos.idArchivo1!=0">
					<tr>
						...
						<td class="cuerpo1TextoResumen"><a
							href="${pageContext.request.contextPath}/comprador/showDoc.do?idArchivo=${requerimientos.idArchivo1}&nameArchivo=${requerimientos.archivo1FileName}&mimeArchivo=${requerimientos.archivo1ContentType}">${requerimientos.archivo1FileName}</a>
						</td>
					</tr>
				</s:if>
				<s:if test="requerimientos.idArchivo2!=0">
					<tr>
						...
						<td class="cuerpo1TextoResumen"><a
							href="${pageContext.request.contextPath}/comprador/showDoc.do?idArchivo=${requerimientos.idArchivo2}&nameArchivo=${requerimientos.archivo2FileName}&mimeArchivo=${requerimientos.archivo2ContentType}">${requerimientos.archivo2FileName}</a>
						</td>
					</tr>
				</s:if>
				<s:if test="requerimientos.idArchivo3!=0">
					<tr>
						...
						<td class="cuerpo1TextoResumen"><a
							href="${pageContext.request.contextPath}/comprador/showDoc.do?idArchivo=${requerimientos.idArchivo3}&nameArchivo=${requerimientos.archivo3FileName}&mimeArchivo=${requerimientos.archivo3ContentType}">${requerimientos.archivo3FileName}</a>
						</td>
					</tr>
				</s:if>
				<s:if test="requerimientos.idArchivo4!=0">
					<tr>
						...
						<td class="cuerpo1TextoResumen"><a
							href="${pageContext.request.contextPath}/comprador/showDoc.do?idArchivo=${requerimientos.idArchivo4}&nameArchivo=${requerimientos.archivo4FileName}&mimeArchivo=${requerimientos.archivo4ContentType}">${requerimientos.archivo4FileName}</a>
						</td>
					</tr>
				</s:if>
				<s:if test="requerimientos.idArchivo5!=0">
					<tr>
						...
						<td class="cuerpo1TextoResumen"><a
							href="${pageContext.request.contextPath}/comprador/showDoc.do?idArchivo=${requerimientos.idArchivo5}&nameArchivo=${requerimientos.archivo5FileName}&mimeArchivo=${requerimientos.archivo5ContentType}">${requerimientos.archivo5FileName}</a>
						</td>
					</tr>
				</s:if>
				<s:if test="requerimientos.idArchivo6!=0">
					<tr>
						...
						<td class="cuerpo1TextoResumen"><a
							href="${pageContext.request.contextPath}/comprador/showDoc.do?idArchivo=${requerimientos.idArchivo6}&nameArchivo=${requerimientos.archivo6FileName}&mimeArchivo=${requerimientos.archivo6ContentType}">${requerimientos.archivo6FileName}</a>
						</td>
					</tr>
				</s:if>
				<s:if test="requerimientos.idArchivo7!=0">
					<tr>
						...
						<td class="cuerpo1TextoResumen"><a
							href="${pageContext.request.contextPath}/comprador/showDoc.do?idArchivo=${requerimientos.idArchivo7}&nameArchivo=${requerimientos.archivo7FileName}&mimeArchivo=${requerimientos.archivo7ContentType}">${requerimientos.archivo7FileName}</a>
						</td>
					</tr>
				</s:if>
				<s:if test="requerimientos.idArchivo8!=0">
					<tr>
						...
						<td class="cuerpo1TextoResumen"><a
							href="${pageContext.request.contextPath}/comprador/showDoc.do?idArchivo=${requerimientos.idArchivo8}&nameArchivo=${requerimientos.archivo8FileName}&mimeArchivo=${requerimientos.archivo8ContentType}">${requerimientos.archivo8FileName}</a>
						</td>
					</tr>
				</s:if>
				<s:if test="requerimientos.idArchivo9!=0">
					<tr>
						...
						<td class="cuerpo1TextoResumen"><a
							href="${pageContext.request.contextPath}/comprador/showDoc.do?idArchivo=${requerimientos.idArchivo9}&nameArchivo=${requerimientos.archivo9FileName}&mimeArchivo=${requerimientos.archivo9ContentType}">${requerimientos.archivo9FileName}</a>
						</td>
					</tr>
				</s:if>
				<s:if test="requerimientos.idArchivo10!=0">
					<tr>
						...
						<td class="cuerpo1TextoResumen"><a
							href="${pageContext.request.contextPath}/comprador/showDoc.do?idArchivo=${requerimientos.idArchivo10}&nameArchivo=${requerimientos.archivo10FileName}&mimeArchivo=${requerimientos.archivo10ContentType}">${requerimientos.archivo10FileName}</a>
						</td>
					</tr>
				</s:if>
				<tr>
		...
		<s:form
			name="frmCancela"
			action="compradorRequerimientosShow"
			namespace="/comprador"
			theme="simple"
			method="post">
		</s:form>
