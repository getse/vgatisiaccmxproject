				...
				<table class="expediente_tabla">
					...
					<s:if test="requerimientos.idArchivo1!=0">
						<tr>
							...
							<td class="cuerpo1TextoResumen"><a href="${pageContext.request.contextPath}/comprador/showDoc.do?idArchivo=${requerimientos.idArchivo1}&nameArchivo=${requerimientos.archivo1FileName}&mimeArchivo=${requerimientos.archivo1ContentType}">${requerimientos.archivo1FileName}</a>
							</td>
						</tr>
					...
					<s:if test="requerimientos.idArchivo2!=0">
						<tr>
							...
							<td class="cuerpo1TextoResumen"><a href="${pageContext.request.contextPath}/comprador/showDoc.do?idArchivo=${requerimientos.idArchivo2}&nameArchivo=${requerimientos.archivo2FileName}&mimeArchivo=${requerimientos.archivo2ContentType}">${requerimientos.archivo2FileName}</a>
							</td>
						</tr>
					...
					<s:if test="requerimientos.idArchivo3!=0">
						<tr>
							...
							<td class="cuerpo1TextoResumen"><a href="${pageContext.request.contextPath}/comprador/showDoc.do?idArchivo=${requerimientos.idArchivo3}&nameArchivo=${requerimientos.archivo3FileName}&mimeArchivo=${requerimientos.archivo3ContentType}">${requerimientos.archivo3FileName}</a>
							</td>
						</tr>
					...
					<s:if test="requerimientos.idArchivo4!=0">
						<tr>
							...
							<td class="cuerpo1TextoResumen"><a href="${pageContext.request.contextPath}/comprador/showDoc.do?idArchivo=${requerimientos.idArchivo4}&nameArchivo=${requerimientos.archivo4FileName}&mimeArchivo=${requerimientos.archivo4ContentType}">${requerimientos.archivo4FileName}</a>
							</td>
						</tr>
					...
					<s:if test="requerimientos.idArchivo5!=0">
						<tr>
							...
							<td class="cuerpo1TextoResumen"><a href="${pageContext.request.contextPath}/comprador/showDoc.do?idArchivo=${requerimientos.idArchivo5}&nameArchivo=${requerimientos.archivo5FileName}&mimeArchivo=${requerimientos.archivo5ContentType}">${requerimientos.archivo5FileName}</a>
							</td>
						</tr>
					...
					<s:if test="requerimientos.idArchivo6!=0">
						<tr>
							...
							<td class="cuerpo1TextoResumen"><a href="${pageContext.request.contextPath}/comprador/showDoc.do?idArchivo=${requerimientos.idArchivo6}&nameArchivo=${requerimientos.archivo6FileName}&mimeArchivo=${requerimientos.archivo6ContentType}">${requerimientos.archivo6FileName}</a>
							</td>
						</tr>
					...
					<s:if test="requerimientos.idArchivo7!=0">
						<tr>
							...
							<td class="cuerpo1TextoResumen"><a href="${pageContext.request.contextPath}/comprador/showDoc.do?idArchivo=${requerimientos.idArchivo7}&nameArchivo=${requerimientos.archivo7FileName}&mimeArchivo=${requerimientos.archivo7ContentType}">${requerimientos.archivo7FileName}</a>
							</td>
						</tr>
					...
					<s:if test="requerimientos.idArchivo8!=0">
						<tr>
							...
							<td class="cuerpo1TextoResumen"><a href="${pageContext.request.contextPath}/comprador/showDoc.do?idArchivo=${requerimientos.idArchivo8}&nameArchivo=${requerimientos.archivo8FileName}&mimeArchivo=${requerimientos.archivo8ContentType}">${requerimientos.archivo8FileName}</a>
							</td>
						</tr>
					...
					<s:if test="requerimientos.idArchivo9!=0">
						<tr>
							...
							<td class="cuerpo1TextoResumen"><a href="${pageContext.request.contextPath}/comprador/showDoc.do?idArchivo=${requerimientos.idArchivo9}&nameArchivo=${requerimientos.archivo9FileName}&mimeArchivo=${requerimientos.archivo9ContentType}">${requerimientos.archivo9FileName}</a>
							</td>
						</tr>
					...
					<s:if test="requerimientos.idArchivo10!=0">
						<tr>
							...
							<td class="cuerpo1TextoResumen"><a href="${pageContext.request.contextPath}/comprador/showDoc.do?idArchivo=${requerimientos.idArchivo10}&nameArchivo=${requerimientos.archivo10FileName}&mimeArchivo=${requerimientos.archivo10ContentType}">${requerimientos.archivo10FileName}</a>
							</td>
						</tr>
								...
								<table width="99%" cellspacing="1" cellpadding="1">
									...
									<tbody>
										<s:iterator value="#vlistRespuestas" status="stat">
											...
											<td class="${((stat.index % 2) == 0) ? 'cuerpo1TablaResumen' : 'cuerpo2TablaResumen'}"
													align="center"><a href="${pageContext.request.contextPath}/comprador/compradorRequerimientoRespuesta.do?idRespuesta=${idRespuesta}" onclick="javascript: $(idProcesa)[0].style.display = 'block';">Respuesta</a></td>
											<td class="${((stat.index % 2) == 0) ? 'cuerpo1TablaResumen' : 'cuerpo2TablaResumen'}"
												align="center">${nombrePyME}</td>
											<td class="${((stat.index % 2) == 0) ? 'cuerpo1TablaResumen' : 'cuerpo2TablaResumen'}"
														align="center"><a href="${pageContext.request.contextPath}/comprador/compradorRequerimientoPyME.do?idUsuario=${idPyME}" onclick="javascript: $(idProcesa)[0].style.display = 'block';">Expediente</a></td>
											</tr>
										</s:iterator>
									</tbody>
								</table>
