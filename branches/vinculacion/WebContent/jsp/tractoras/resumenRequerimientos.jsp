	...
	<table>
		<tr>
			...
			<s:label
				...
				id="idCampoTipoProducto"
				name="requerimientos.tipoProducto"
				value="%{requerimientos.tipoProducto}" /> <a href="javascript:buscar();">buscar</a><br />
			...
			<s:label
				cssClass="etiquetaCaptura"
				value="* Fecha de suministro:" /> <input
				class="calendario"
				id="ingreso"
				name="igreso"
				onchange="limpiaCheckSuministro();"
				value="<s:property value='requerimientos==null||requerimientos.fechaSuministro==null?"dd-mm-yyyy":requerimientos.fechaSuministro' />"
				size="18" /> <s:date
				id="idCampoFechaSuministro"
				name="requerimientos.fechaSuministro" /> <img
			...
			<input
				...
				type="checkbox"
				${requerimientos.bIndefinido==true?
				' checked="checked"':' ' } ></input><s:label
				cssClass="etiquetaCaptura"
				value="Indefinido" /></input>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
				class="checkbox"
				id="variasfechas"
				name="persiste"
				...
				cssClass="etiquetaCaptura"
				value="Varias fechas" /></input>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
				class="checkbox"
				id="suministrocontinuo"
				name="continuo"
				onchange="limpiaFechaExpira(3);"
				type="checkbox"
				${requerimientos.bContinuoSuministro==true?
				' checked="checked"':' ' } ><s:label
				cssClass="etiquetaCaptura"
				value="Continuo" /></input> <br />
			<s:label
				cssClass="etiquetaAyuda"
			...
			<s:label
				cssClass="etiquetaCaptura"
				value="Condiciones de pago:" /> <input
				class="checkbox"
				id="checkcontado"
				name="requerimientos.bContado"
				type="checkbox"
				onclick="contado();"
				${requerimientos.bContado==true?
				' checked="checked"':' ' } ><s:label
				cssClass="etiquetaCaptura"
				value="Contado" /></input>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
				class="checkbox"
				id="checkcredito"
				name="checkcredito"
				type="checkbox"
			...
			<div
				...
				${requerimientos.bQuince==true?
				' checked="checked"':' ' } ><s:label
				cssClass="etiquetaCaptura"
				value="15 días" /></input>&nbsp;&nbsp;&nbsp; <input
				class="checkbox"
				id="checktreinta"
				name="requerimientos.bTreinta"
				type="checkbox"
				onclick="limpiaCheckCredito(30);"
				${requerimientos.bTreinta==true?
				' checked="checked"':' ' } ><s:label
				cssClass="etiquetaCaptura"
				value="30 días" /></input>&nbsp;&nbsp;&nbsp; <input
				class="checkbox"
				id="checksesenta"
				name="requerimientos.bSesenta"
				type="checkbox"
				onclick="limpiaCheckCredito(60);"
				${requerimientos.bSesenta==true?
				' checked="checked"':' ' } ><s:label
				cssClass="etiquetaCaptura"
				value="60 días" /></input>&nbsp;&nbsp;&nbsp; <input
				class="checkbox"
				id="checknoventa"
				name="requerimientos.bNoventa"
				type="checkbox"
				onclick="limpiaCheckCredito(90);"
				${requerimientos.bNoventa==true?
				' checked="checked"':' ' } ><s:label
				cssClass="etiquetaCaptura"
				value="90 días" /></input>&nbsp;&nbsp;&nbsp; <input
				class="checkbox"
				id="checkotro"
			...
			<s:label
				cssClass="etiquetaCaptura"
				value="* Fecha en la que expira el requerimiento:" /> <input
				class="calendario"
				id="ingreso2"
				name="igreso"
				onchange="limpiaCheckExpira();"
				value="<s:property value='requerimientos==null||requerimientos.fechaExpira==null?"dd-mm-yyyy":requerimientos.fechaExpira' />"
				size="18" /> <s:date
				id="idCampoFechaExpira"
				name="requerimientos.fechaExpira" /> <img
				src="${pageContext.request.contextPath}/img/calendario.png"
				width="16"
				height="16"
				title="Seleccione una fecha"
			...
			<input
				...
				${requerimientos.bContinuoExpira==true?
				' checked="checked"':' ' }><s:label
				cssClass="etiquetaCaptura"
				value="Continuo" /></input> <br />
			<s:label
...
<iframe
	id="iframeDenoMua"
	name="denoMua"
	src='${pageContext.request.contextPath}/tractora/requerimientos/showPro.do?requerimientos.idRequerimiento=${requerimientos.idRequerimiento}&requerimientos.tipoProducto=${requerimientos.tipoProducto}&busqueda=true'
	width="700px"
	height="250px"
	frameborder="0"> </iframe> <span class="close">Cancelar</span> <s:url
	id="uri"
	action="addReq"
	encode="true"
	namespace="/tractora/requerimientos"
	includeContext="" /> <s:form
	id="idFrmRegresar"
	name="frmRegresar"
	action="%{uri}"
	method="get">
