				...
				<tbody>
					<s:iterator
						...
						<tr>
							...
							<td class="${((stat.index % 2) == 0) ? 'cuerpo1TablaResumen' : 'cuerpo2TablaResumen'}" align="center">
								<a href='${pageContext.request.contextPath}/comprador/compradorRequerimientoAdd.do?requerimientos.idRequerimiento=${idRequerimiento}'> Modificar </a>
							</td>
							<td class="${((stat.index % 2) == 0) ? 'cuerpo1TablaResumen' : 'cuerpo2TablaResumen'}" align="center">
...
<s:form
	name="frmBorrar"
	action="compradorRequerimientoDelete"
	namespace="/comprador"
	theme="simple"
	method="get">
	<s:hidden
