...
<body>
				...
				<table align="center">
					...
					<tr >
						...
						<s:form
								name="reporte1"
								action="reportesShow"
								namespace="/ccmx/administracion/reportes"
								method="post"
								theme="simple">
					...
					<tr>
						<td align="center" class="cuerpo2TablaResumen" align="left">
							<s:form
								name="reporte3"
								action="reportesShow"
								namespace="/ccmx/administracion/reportes"
			...
			<s:form
				...
				<table >
					...
					<tr >
						...
						<td style="width: 180px;">
									<select name="filtros.cedula" id="cedulaPy" style="display:none;">
										<option value="-1">--Seleccionar--</option>
	...
	<div id="descargas" ${opcion!=null && opcion=='descarga'?' style="display: block;"':' style="display: none;"'}>
		...
		<s:if test="salida==null">				
			<br/>
				<a href="${pageContext.request.contextPath}/ccmx/administracion/downDoc.do" >Descargar Archivo</a>
		</s:if>
		<s:else>
