								...
								<tr>
									<td colspan="2">
										<s:label cssClass="etiquetaAyuda" id="ayudasDisplay222" style="display:none; margin-top:5px;"
											value="Incluya el mensaje principal que desea que vea las Grandes Empresas." />
									</td>
								</tr>
								<tr>
									<td>
					...
					<table width="99%">
						...
						<tr>
							...
							<td>
								...
								<s:label id="ayudasDisplay29" style="display:none; margin-top:5px;" cssClass="etiquetaAyuda" value="Describa los principales productos que le vende a las Grandes Empresas." />
							</td>
						</tr>
						<tr>
							<td colspan="2">
						...
						<tr>
							<td colspan="2">
								<s:label cssClass="etiquetaAyuda" id="ayudasDisplay30" style="display:none; margin-top:5px;"
											value="Escriba los años y meses que lleva como proveedor de las Grandes Empresas." />
							</td>
						</tr>
					</table>
