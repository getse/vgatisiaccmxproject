					...
					<td>
						<table>
							...
							<tr>
								...
								<select id="catProd2" name="cat2" style="width: 500px; display: none;" onchange="javascript: showCombo(this.value,3);" onfocus="javascript: ayudasHelp('3');" onblur="javascript:ayudasHelpBlo('3');">
									<option selected="selected" value="-1">--Seleccione una opción--</option>
									<s:iterator value="listCat2" status="stat" >
										<option value="${cveScian}">${descScian}</option>
									</s:iterator>
								</select>
								<select id="catProd3" name="cat3" style="width: 500px; display: none;" onchange="javascript: showCombo(this.value,4);" onfocus="javascript: ayudasHelp('3');" onblur="javascript:ayudasHelpBlo('3');">
									<option selected="selected" value="-1">--Seleccione una opción--</option>
									<s:iterator value="listCat3" status="stat" >
										<option value="${cveScian}">${descScian}</option>
									</s:iterator>
								</select>
								<select id="catProd4" name="cat4" style="width: 500px; display: none;" onchange="javascript: showCombo(this.value, 5);" onfocus="javascript: ayudasHelp('3');" onblur="javascript:ayudasHelpBlo('3');">
									<option selected="selected" value="-1">--Seleccione una opción--</option>
									<s:iterator value="listCat4" status="stat" >
										<option value="${cveScian}">${descScian}</option>
									</s:iterator>
								</select>
								<select id="catProd5" name="cat5" style="width: 500px; display: none;" onchange="javascript: showCombo(this.value, 6);" onfocus="javascript: ayudasHelp('3');" onblur="javascript:ayudasHelpBlo('3');">
									<option selected="selected" value="-1">--Seleccione una opción--</option>
						...
						<s:if test="%{personalidadJuridica != null}">
							<tr>
								...
								<td class="${((stat.index % 2) == 0) ? 'cuerpo1TablaResumen' : 'cuerpo2TablaResumen'}" align="center">
									<a href="${pageContext.request.contextPath}/pyme/pymeBusquedaShow.do?idUsuario=${idUsuario}" onclick="javascript: $(idProcesa)[0].style.display = 'block';">Expediente</a>
								</td>
							</tr>
						</s:if>
					</s:iterator>
