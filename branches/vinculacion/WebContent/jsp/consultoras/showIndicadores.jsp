						...
						<s:iterator value="listPyMEs" status="stat">
								...
								<tr>
									...
									<td class="${((stat.index % 2) == 0) ? 'cuerpo1TablaResumen' : 'cuerpo2TablaResumen'}"
													...
													/consultor/consultorIndicadoresShow.do?idUsuario=${idUsuario}">Ver Expediente</a></td>
									<td class="${((stat.index % 2) == 0) ? 'cuerpo1TablaResumen' : 'cuerpo2TablaResumen'}"
													align="center"><a href="${pageContext.request.contextPath}
													/consultor/consultorIndicadorShow.do?seguimiento=${idUsuario}">Seguimiento</a></td>
