...
function showForm(val) {
	...
	if(  combo != 0 ){
		...
		if(combo == 1){
			...
			descripcion.innerHTML = 'Ahorros generados a las Grandes Empresas en comparación con otros proveedores en la misma cotización';
			...
			uniMed.value = porcentaje;
			descripcion.innerHTML = 'Ahorros generados a las Grandes Empresas en comparación con su desempeño antes de tomar los servicios del CCMX.';
			...
			indi.value = 'Crecimiento en ventas anuales a las Grandes Empresas (a nivel de producto)';
			uniMed.value = porcentaje;
			descripcion.innerHTML = 'Indica el aumento en la producción que le vende a una de las Grandes Empresas.';
