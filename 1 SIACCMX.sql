...
CEDULA VARCHAR(10),
F_AVISO_PRIVACIDAD TIMESTAMP,
NOMBRE_TERMINOS VARCHAR(60),
APP_PATERNO_TERMINOS VARCHAR(60),
APP_MATERNO_TERMINOS VARCHAR(60),
B_INHIBIR_VINCULACION BOOLEAN,
CARGA_MASIVA BOOLEAN,
LIBERA_EXPEDIENTE BOOLEAN);
...
B_NOVENTA BOOLEAN,
B_OTRO BOOLEAN,
OTRAS_CONDICIONES VARCHAR(2000),
REQUISITOS_ADICIONALES VARCHAR(2000),
FECHA_EXPIRA DATE,
...
ALTER TABLE INFRA.ENCUESTAS ADD CONSTRAINT ENC_SESION_FK FOREIGN KEY(ID_SESION) REFERENCES INFRA.SESIONES(ID_SESION);
...
ESTATUS VARCHAR(40),
RECURSOS_HUMANOS_ANTES FLOAT,
MERCADEO_ANTES FLOAT,
FINANZAS_ANTES FLOAT,
ADMINISTRACION_ANTES FLOAT,
PROCESOS_ANTES FLOAT,
RECURSOS_HUMANOS_DESPUES FLOAT,
MERCADEO_DESPUES FLOAT,
FINANZAS_DESPUES FLOAT,
ADMINISTRACION_DESPUES FLOAT,
PROCESOS_DESPUES FLOAT,
...
ALTER TABLE INFRA.ARCHIVOS ADD CONSTRAINT IDUSUARIORFC_U UNIQUE (ID_USUARIO_RFC);
...
--- USUARIOS
INSERT INTO INFRA.USUARIOS (CVE_USUARIO, PASSWORD) VALUES ('admin.ccmx@mail.com', 'Ccmx3429');
INSERT INTO INFRA.ADMINISTRACION_CCMX VALUES (1);
INSERT INTO INFRA.USUARIOS (CVE_USUARIO, PASSWORD) VALUES ('coordinador.diplomado@mail.com', 'Ccmx5132');
INSERT INTO INFRA.COORDINADORES_DIPLOMADOS VALUES ( (SELECT MAX(ID_USUARIO) FROM INFRA.USUARIOS ),1);
INSERT INTO INFRA.ADMINISTRACION_CCMX VALUES (2);
INSERT INTO INFRA.USUARIOS (CVE_USUARIO, PASSWORD) VALUES ('coordinador.consultoria@mail.com', 'Ccmx3922');
INSERT INTO INFRA.COORDINADORES_CONSULTORA VALUES ( (SELECT MAX(ID_USUARIO) FROM INFRA.USUARIOS ),1);
INSERT INTO INFRA.ADMINISTRACION_CCMX VALUES (3);
